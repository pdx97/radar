...
void draw()
{
  ...
  drawRadar(); //calling the function for drawing the radar
  drawLine(); // calling the function for drawing the lines 
  drawObject();// calling the function for object
  drawText();// calling the function for text
}

void serialEvent(Serial myPort) // starts reading the serial port
{
